...
-- Дамп данных таблицы trkhai.group: ~1 rows (приблизительно)
...
-- Дамп данных таблицы trkhai.homework: ~2 rows (приблизительно)
/*!40000 ALTER TABLE `homework` DISABLE KEYS */;
INSERT INTO `homework` (`id`, `name`, `date_of_delivery`) VALUES
	(0, 'firsHomework', '2015-11-01'),
	(2, 'adawawd', '2015-12-20');
...
-- Дамп данных таблицы trkhai.homework_task: ~2 rows (приблизительно)
...
-- Дамп структуры для таблица trkhai.teacher
...
CREATE TABLE IF NOT EXISTS `teacher` (
  ...
  KEY `FK_teacher_training` (`training_id`),
  CONSTRAINT `FK_teacher_training` FOREIGN KEY (`training_id`) REFERENCES `training` (`id`),
  CONSTRAINT `FK_teacher_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- Дамп данных таблицы trkhai.teacher: ~3 rows (приблизительно)
/*!40000 ALTER TABLE `teacher` DISABLE KEYS */;
INSERT INTO `teacher` (`id`, `user_id`, `training_id`) VALUES
	(1, 1, 1),
	(2, 1, 2);
...
-- Дамп данных таблицы trkhai.training: ~2 rows (приблизительно)
...
-- Дамп данных таблицы trkhai.user: ~2 rows (приблизительно)
...
INSERT INTO `user` (`id`, `group_id`, `name`, `surname`, `middle_name`, `role`, `password`) VALUES
	...
	(1, 1, 'user', '1', 'user', 'TEACHER', '123456');
...
CREATE TABLE IF NOT EXISTS `user_home_work` (
  ...
  KEY `FK_user_home_work_solution` (`solution_id`),
  ...
  CONSTRAINT `FK_user_home_work_solution` FOREIGN KEY (`solution_id`) REFERENCES `solution` (`id`),
...
-- Дамп данных таблицы trkhai.user_home_work: ~2 rows (приблизительно)
/*!40000 ALTER TABLE `user_home_work` DISABLE KEYS */;
INSERT INTO `user_home_work` (`id`, `user_id`, `home_work_id`, `home_work_task_id`, `training_id`, `solution_id`) VALUES
	(1, 0, 0, 1, 2, NULL),
	(3, 0, 0, 2, 1, NULL);
